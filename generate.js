...
program
    ...
    .option(
        '-m, --csvFilePathToMergeWith <csvFilePathToMergeWith>',
        'CSV file to merge new generated data with. Cannot be provided if csvFilesNames option was given. Merging is not writing new column names to the CSV.'
    )
